<x-app-layout>
    <div x-data="{
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-1">Next 7 Days</h1>
        <p class="text-sm text-gray-500 mb-6">{{ now()->format('M j') }} - {{ now()->addDays(7)->format('M j, Y') }}</p>
        ...
        <div class="space-y-1">
            ...
            <div x-show="tasks.length === 0" class="text-center text-gray-400 py-12">No tasks due this week</div>
        </div>
