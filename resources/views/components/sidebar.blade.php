<aside class="w-52 h-screen flex flex-col flex-shrink-0 bg-gray-900 text-white">
    ...
    <nav class="flex-1 px-3 space-y-0.5">
        ...
        <a href="{{ route('calendar') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm {{ request()->routeIs('calendar*') ? 'bg-violet-600/20 text-violet-400' : 'text-gray-400 hover:text-white hover:bg-white/5' }} transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
